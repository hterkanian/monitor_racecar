...
"""
    ...
    2.  Default student file: default_file = assignment_3.pkl
    3.  Default control topic: self.control_topic = '/hst/control'

    Termination:
    Publishing any string message to /hst/control topic.

    Reset:
    To clear the student list delete the file named in default_file 
"""
